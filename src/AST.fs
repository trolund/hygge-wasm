...
and Expr<'E, 'T> =
    ...
    | ShortAnd of lhs: Node<'E, 'T> * rhs: Node<'E, 'T>

    /// Short-circuit or between lhs and rhs.
    | ShortOr of lhs: Node<'E, 'T> * rhs: Node<'E, 'T>
    ...
    | LessOrEq of lhs: Node<'E, 'T> * rhs: Node<'E, 'T>
    ...
    | GreaterOrEq of lhs: Node<'E, 'T> * rhs: Node<'E, 'T>
    ...
    | Min of lhs: Node<'E, 'T> * rhs: Node<'E, 'T>

    | Max of lhs: Node<'E, 'T> * rhs: Node<'E, 'T>
    ...
    | DoWhile of body: Node<'E, 'T> * condition: Node<'E, 'T>

    /// 'For' loop: execute 'init'. As long as 'cond' is true, repeat the 'body' and 'update'
    | For of init: Node<'E, 'T> * cond: Node<'E, 'T> * update: Node<'E, 'T> * body: Node<'E, 'T>
    ...
    | ArrayElement of target: Node<'E, 'T> * index: Node<'E, 'T>
