(module
  ...
  (type $s_i32-eqref_i32_=>_i32 (;2;) (func (param (ref null eq)) (param i32) (result i32)))
  ...
  (type $s_ (;5;) (struct ))
  (type $s_i32-s_ (;6;) (struct (field $f (mut i32)) (field $cenv (ref null $s_))))
  (memory (;0;) (export "memory") 1)
  (global $exit_code (;0;) (mut i32) (i32.const 0))
  (global $fun_outer*ptr (;1;) (mut (ref null $s_i32-s_)) (ref.null $s_i32-s_))
    ...
    (drop ;; drop value of subtree
      ...
      (call_indirect (type $s_i32-eqref_i32_=>_i32) ;; call function
        (struct.get $s_i32-eqref 1 ;; load closure environment pointer
          (ref.cast (ref $s_i32-eqref) ;; cast to subtype
  ...
  (func $fun_outer (;1;) (param $cenv (ref null eq)) (param $arg_x i32) (result i32) 
