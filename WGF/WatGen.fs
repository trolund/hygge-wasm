...
let instrLabel i =
    ...
    | Comment(_) -> ""
    | Drop_ -> failwith "Not Implemented"
    | ArrayNew(_, _) -> failwith "Not Implemented"
    | ArraySet(_, _) -> failwith "Not Implemented"
    | ArrayGet(_, _) -> failwith "Not Implemented"
    | RefCast(_, _) -> failwith "Not Implemented"
    | Null(_) -> failwith "Not Implemented"
