(module
  ...
  (global $fun_makeCounters/anonymous$3*ptr (mut i32) i32.const 8)
  ...
  (func $_start  (result i32) ;; entry point of program (main function)
    ...
    i32.load offset=0 ;; load field: increment
    ;; End of field select
    i32.const 4 ;; 4 byte offset
    i32.add ;; add offset
    i32.load ;; load closure environment pointer
    ...
    ;; Start of field select
    global.get $var_c1 ;; get local var: var_c1, have been hoisted
    i32.load offset=4 ;; load field: decrement
    ;; End of field select
    i32.const 4 ;; 4 byte offset
    i32.add ;; add offset
    i32.load ;; load closure environment pointer
