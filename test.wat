(module
  ...
  (global $fun_makeCounters/anonymous$6*ptr (;3;) (mut i32) i32.const 12)
  (global $fun_makeCounters/anonymous$9*ptr (;4;) (mut i32) i32.const 16)
  (global $fun_makeCounters/anonymous*ptr (;5;) (mut i32) i32.const 4)
  ...
  (func $fun_makeCounters/anonymous$6 (;4;) (param $cenv i32) (result i32) 
    ;; Start of field select
    local.get 0 ;; get env pointer
    i32.load offset=0 ;; load value at offset: 0
    i32.load offset=0 ;; load field: value
  ...
  (func $fun_makeCounters/anonymous$9 (;5;) (param $cenv i32) (result i32) 
    local.get 0 ;; get env pointer
    i32.load offset=0 ;; load value at offset: 0
    ;; Start of field select
    local.get 0 ;; get env pointer
