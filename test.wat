(module
  ...
  (func $fun_makeCounters (;1;) (param $cenv i32) (result i32) ;; function fun_makeCounters    ;; local variables declarations:
    (local $Sptr i32)
    (local $Sptr$0 i32)
    (local $Sptr$1 i32)
    (local $Sptr$2 i32)
  ...
  (func $fun_makeCounters/anonymous (;2;) (param $cenv i32) (result i32) ;; function fun_makeCounters/anonymous    ;; local variables declarations:
    (local $Sptr i32)
  ...
  (func $fun_makeCounters/anonymous$3 (;3;) (param $cenv i32) (result i32) ;; function fun_makeCounters/anonymous$3    ;; local variables declarations:
    (local $Sptr i32)
