(module
  ...
  (global $fun_f*ptr (;6;) (mut i32) i32.const 60)
  (global $heap_base (;7;) i32 i32.const 200)
  ...
  (func $_start (;0;)  (result i32) 
    ...
    i32.const 64 ;; leave pointer to string on stack
    i32.load ;; Load string pointer
    i32.const 64 ;; leave pointer to string on stack
    i32.load offset=4 ;; Load string length
    call $writeS ;; call host function
    ...
    i32.const 124 ;; leave pointer to string on stack
    i32.load ;; Load string pointer
    i32.const 124 ;; leave pointer to string on stack
    i32.load offset=4 ;; Load string length
    call $writeS ;; call host function
  ...
  (data (i32.const 0) "\08\00\00\00\34\00\00\00")
  (data (i32.const 8) "--------------------------")
  (data (i32.const 60) "\00")
  (data (i32.const 64) "\48\00\00\00\34\00\00\00")
  (data (i32.const 72) "--------------------------")
  (data (i32.const 124) "\84\00\00\00\34\00\00\00")
  (data (i32.const 132) "--------------------------")
  (data (i32.const 184) "\c0\00\00\00\08\00\00\00")
  (data (i32.const 192) "None")
